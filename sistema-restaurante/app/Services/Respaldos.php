...
class Respaldos
{
    ...
    {
        $ruta = config('restaurante.respaldos.ruta') ?: storage_path('app/respaldos');
    ...
    {
        $ruta = trim((string) config('restaurante.respaldos.copia'));
    ...
    {
        $remoto = trim((string) config('restaurante.respaldos.nube'));
    ...
    private static function subirALaNube(array $archivos): array
    {
        ...
        $rclone = (string) config('restaurante.respaldos.rclone', 'rclone');
