...
class RespaldosTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config([
            'restaurante.respaldos.ruta' => $this->carpeta,
            'restaurante.respaldos.nube' => null,
        ]);
    }
    ...
    {
        config(['restaurante.respaldos.nube' => 'drive:']);
        Process::fake();
    ...
    {
        config(['restaurante.respaldos.nube' => 'drive:restaurante/']);
        Process::fake();
    ...
    {
        config(['restaurante.respaldos.nube' => null]);
        Process::fake();
    ...
    public function test_cada_respaldo_se_copia_a_la_carpeta_de_afuera(): void
    {
        ...
        config(['restaurante.respaldos.copia' => $afuera]);
