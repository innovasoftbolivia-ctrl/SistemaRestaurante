<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Logo (solo móvil) -->
            <a href="{{ url(\App\Support\Menu::inicio()) }}" class="flex min-w-0 items-center gap-2.5 xl:hidden">
                <x-common.icono-negocio size="sm" />
                <span class="truncate text-base font-semibold text-gray-900 dark:text-white">{{ \App\Support\Config::negocio() }}</span>
            </a>
